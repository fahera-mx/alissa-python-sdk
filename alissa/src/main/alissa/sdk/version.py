...
try:
    version = Version.from_path(name="alissa", dirpath=os.path.dirname(__file__))
except Exception:
    print("Version file not found for package name: alissa, using 0.0.0")
    version = Version(name="alissa", value="0.0.0")
